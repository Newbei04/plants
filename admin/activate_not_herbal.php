...
$query = "SELECT * FROM not_herbal_details WHERE value= '1'";
...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Archived Not Herbal</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Archived Not Herbal</li>
            </ol>
        </div>
    </div>
    ...
    document.querySelectorAll(".activate-btn").forEach(btn => {
        btn.addEventListener("click", function() {
            ...
            Swal.fire({
                ...
                text: "It will be restored to active list.",
                icon: "success",
                ...
                if (result.isConfirmed) {
                    ...
                    fetch("update_status_not_herbal.php", {
                        method: "POST",
                        headers: {
