                            ...
                            <tbody>
                                ...
                                ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="../uploads/<?php echo htmlspecialchars($row['image']); ?>" width="100px"></td>
                                            <!-- Add this line -->
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                echo '<ul style="list-style-type: disc; margin-left: 1.5rem;">' . implode('', array_map(fn($u) => '<li>' . htmlspecialchars(trim($u)) . '</li>', $uses)) . '</ul>';
                                                ?>
                                            </td>
                                            <td>
