...
<body>
    ...
    <section class="product-container">
        <!-- left side -->
        <div class="img-card">
            <img src="uploads/<?php echo $notherbalDetail['image']; ?>" alt="Not Herbal Image" />
            <!-- small img -->
        </div>
        <!-- Right side -->
        <div class="product-info">
            <h3>
                <?php echo $notherbalDetail['scientific_name']; ?>
            </h3>
            <br>
            <div>
                <p>Description:</p>
                <p>
                    <?php echo $notherbalDetail['description']; ?>
                </p>
