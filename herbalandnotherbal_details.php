...
if (isset($_GET['id'])) {
    ...
    if ($resultHerbal->num_rows > 0) {
        ...
        if ($resultNotHerbal->num_rows > 0) {
            ...
            $detail = $resultNotHerbal->fetch_assoc();
        } else {
...
<body>
    ...
    <br><br>
    <br><br>
    <?php if ($detailType === 'herbal'): ?>
        <!-- Display herbal details -->
        <section class="product-container">
            <div class="img-card">
                <img src="uploads/<?php echo $detail['image']; ?>" alt="Herbal Image" />
            </div>
            <div class="product-info">
                <h3>
                    <?php echo $detail['scientific_name']; ?>
                </h3>
                <div>
                    <p>Meaning:</p>
                    <p>
                        <?php echo $detail['meaning']; ?>
                    </p>
                    <p>Can Use To:</p>
                    <p>
                        <?php echo $detail['can_use_to']; ?>
                    </p>
                    <p>How to Use:</p>
                    <p>
                        <?php echo $detail['how_to_use']; ?>
                    </p>
                    <p>Trivia:</p>
                    <p>
                        <?php echo $detail['trivia']; ?>
                    </p>
                </div>
            </div>
        </section>
    <?php elseif ($detailType === 'not_herbal'): ?>
        <!-- Display not herbal details -->
        <section class="product-container">
            <div class="img-card">
                <img src="uploads/<?php echo $detail['image']; ?>" alt="Not Herbal Image" />
            </div>
            <div class="product-info">
                <h3>
                    <?php echo $detail['scientific_name']; ?>
